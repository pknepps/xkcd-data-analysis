...
words_total <- parsed_comic$scene |> tolower() |> append(parsed_comic$dialog |> tolower())
all_words <- lapply(words_total, \(x) str_split(x, remove_characters_regex, simplify = TRUE))
